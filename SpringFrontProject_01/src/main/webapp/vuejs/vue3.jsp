...
<div class="container">
	...
	<script>
		new Vue({
			...
			mounted:function(){
				console.log("mounted:가상메모리(가상돔)에 HTML 올리기 완료...")
			...
			beforeUpdate:function(){
				...
				// 멤버 변수 설정 : react=>state , Vue => data를 다른 메소드에서 변경시에는 this.
			},
			updated:function(){
				console.log("updated:상태 변경(데이터값 변경)이나 수정이 완료된 상태 =>mounted를 재호출")
			},
