...
public class GoodsRestController {
	...
	// 상세보기
	/*
	 * no,goods_name as name,goods_sub as sub,"
			+ "goods_price as price, goods_discount as discount, goods_first_price as first_price, goods_delivery as delivery,"
			+ "goods_poster as poster, hit "
	 */
