...
public class DataBoardController {
	 ...
	 *            ------------------------------------------
	 *                => 다운로드 , Cookie사용
	 *            HttpSession , Model, RedirctArrtibutes , PasswordEncoder
	 *    DAO : 데이터베이스 연동
	 ...
	 *                   2. Mobile => Kotlin
	 *    Service : BI => DAO 여러개 통합 , 다른 서비스를 통합 (크롤링)
	 */
	...
	@ResponseBody
	public String databoard_delete_ok(String pwd,int no,Model model)
	{
		String result="";
		// DAO 연동
